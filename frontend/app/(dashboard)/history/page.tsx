...
export default function HistoryPage() {
  ...
  return <div className="space-y-5">
    ...
    {result.similar_sessions[0] && <Panel><SectionHeader title="Why the nearest session is similar" description="Direct feature comparison using the same observable inputs returned by the similarity API." /><div className="mt-5"><HistoryFeatureComparison current={result.query_summary} analogue={result.similar_sessions[0]} /></div></Panel>}
